...
async function masukGoogle() {
  ...
  try {
    // Diperiksa lebih dulu. Tanpa ini, provider yang mati membuat pengguna mendarat di halaman
    // JSON mentah tanpa penjelasan apa pun.
...
<template>
  <div>
    <button
      ...
      @click="masukGoogle"
    >
      <!-- Lambang Google resmi, empat warna, dipakai apa adanya sesuai ketentuan mereknya. -->
